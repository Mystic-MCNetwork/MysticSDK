...
copy "%~dp0Package\Version_Configs" "%path%.minecraft\versions\Mystic Client\PCL\"
copy "%~dp0Package\Mods" "%path%.minecraft\versions\Mystic Client\mods"
copy "%~dp0Package\Shaders" "%path%.minecraft\versions\Mystic Client\shaderpacks"
copy "%~dp0Package\Launcher_Configs" "%path%PCL"
copy "%~dp0Package\Background.png" "%path%PCL\Pictures"
